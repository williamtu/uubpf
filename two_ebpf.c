...
static __always_inline int ebpf_filter(struct usk_buff *skb);
/*
...
#define load_byte uload_byte
#define load_half uload_half
#define load_word uload_word
